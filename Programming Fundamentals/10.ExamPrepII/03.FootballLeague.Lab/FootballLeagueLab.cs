...
namespace _03.FootballLeague.Lab
{
    class FootballLeagueLab
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("League standing");
        ...
        private static void AddScoreToTeam(Dictionary<string, int> standings, string firstTeamName, int TeamScore)
        {
            ...
            standings[firstTeamName] += TeamScore;
        }
